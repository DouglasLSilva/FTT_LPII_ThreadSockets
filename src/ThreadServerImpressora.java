    ...
    private Thread threadMessaging = new Thread(){
        ...
        public void run() {
            ...
            ArrayList<ThreadImpressora> impressoraList = new ArrayList<>() {{
                add(new ThreadImpressora("IMPRESSORA 1"));
                add(new ThreadImpressora("IMPRESSORA 2"));
                add(new ThreadImpressora("IMPRESSORA 3"));
                add(new ThreadImpressora("IMPRESSORA 4"));
                add(new ThreadImpressora("IMPRESSORA 5"));
            }};
